...
with tab2_Descriptive_Statistics:
	...
	chart = alt.Chart(hourly_flights).mark_bar().encode(
		...
		width=600,
    	height=800,
		title=alt.TitleParams(text='Flights per Hour', align='center', subtitle='Departures \n Number of flights per airline'),
	).configure_axis(
		grid=False
	).configure_title(
		fontSize=20,
	...
	chart = alt.Chart(hourly_flights).mark_bar().encode(
		...
		width=600,
    	height=800,
		title=alt.TitleParams(text='Flights per Hour', align='center', subtitle='ssArrivals \n Number of flights per airline'),
	).configure_axis(
		grid=False
	).configure_title(
		fontSize=20,
